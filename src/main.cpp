...
void PageHTML()
{
    ...
    page += "</body>";
    page += "</html>";
    server.setContentLength(page.length()); // Indique au navigateur la longueur de la page
...
void PageOn()
{
    ...
    server.send(303);                   // Le serveur indique au navigateur qu’il l’envoie faire une redirection
}
void PageOff()
{
